          ...
          <div class="col-md-6 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4 flex-grow-1">
            <div class="row">
              <div class="col-8 col-sm-8 col-md-6 col-lg-6 mx-auto pb-5">
                <div class="my-card">
                  <div class="my-card-img text-center p-2">
                    <img src='/src/assets/authors/rocco.jpeg' alt="" class="rounded-circle my-img-authors">
                  </div>
                  <div class="my-card-body">
                    <div class="my-card-text">
                      <div class="row my-contact contact-git align-items-center justify-content-center mb-2">
                        <div class="col-auto">
                          <img src="/src/assets/git2.jpg" alt="">
                        </div>
                        <div class="col-6">
              ...
              <div class="col-8 col-sm-8 col-md-6 col-lg-6 mx-auto pb-5">
                <div class="my-card">
                  <div class="my-card-img text-center p-2">
                    <img src="/src/assets/authors/Ale.png" alt="" class="rounded-circle my-img-authors">
                  </div>
                  <div class="my-card-body">
                    <div class="my-card-text">
                      <div class="row my-contact contact-git align-items-center justify-content-center mb-2">
                      ...
                      <div class="row my-contact contact-linkedin align-items-center justify-content-center">
                        ...
                        <div class="col-7">
                          <a href="https://www.linkedin.com/in/alessandro-casalaspro-45911a315/">Alessandro
                            Casalaspro</a>
                        </div>
                      </div>
                    </div>
